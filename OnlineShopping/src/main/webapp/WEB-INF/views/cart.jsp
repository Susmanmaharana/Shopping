			...
			<table id="cart" class="table table-hover table-condensed">
				...
				<tbody>
					<c:forEach items="${cartLines}" var="cartLine">
						...
						<tr>
							...
							<td data-th="Price"><span>&#8377;</span> ${cartLine.buyingPrice} </td>
							<td data-th="Quantity">
							<input type="number"
				...
				<tfoot>
					...
					<tr>
						...
						<span
								class="glyphicon glyphicon-angle-left"></span> Continue Shopping</a></td>
						<td colspan="2" class="hidden-xs"></td>
						<td class="hidden-xs text-center"><strong>Grand Total
								&#8377; ${userModel.cart.grandTotal}</strong></td>
						<td><a href="#" class="btn btn-success btn-block">Checkout
								<span class="glyphicon glyphicon-angle-right"></span>
						</a></td>
					</tr>
				</tfoot>
			</table>
